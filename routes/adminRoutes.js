  ...
  async (req, res, next) => {
    try {
      ...
      const customerMessage =
        `Hello ${order.customer.name}, your Xerox order ${order.orderId} status is: ${order.orderStatus}.`;
...
router.get(
  '/orders/:orderId/download/:fileIndex',
  requireAdmin,
  async (req, res, next) => {
    try {
      const order =
